...
@interface WSYQuickViewController (){
    PYOption *option;
    BabyBluetooth *baby;
}
...
@implementation WSYQuickViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = WSY(@"Schedule");
    self.view.backgroundColor = WSYTheme_Color;
    baby = [WSYDefaultInstance sharedInstance].baby;
    self.currPeripheral =  [WSYDefaultInstance sharedInstance].currPeripheral;
...
//        [SVProgressHUD showInfoWithStatus:[NSString stringWithFormat:@"设备：%@--断开失败",peripheral.name]];
    ...
    [baby setBlockOnDiscoverServicesAtChannel:channelOnPeropheralView block:^(CBPeripheral *peripheral, NSError *error) {
        for (CBService *s in peripheral.services) {
            //            if([s.UUID isEqual:[CBUUID UUIDWithString:@"C4FB2349-72FE-4CA2-94D6-1F3CB16331EE"]]){
            //                //外围设备查找指定服务中的特征
