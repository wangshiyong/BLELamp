...
#import "WSYQuickViewController.h"
...
- (NSArray *)viewControllers {
    WSYDevicesViewController *firstViewController = [[WSYDevicesViewController alloc] init];
    UIViewController *firstNavigationController = [[WSYBaseNavigationController alloc]
                                                   initWithRootViewController:firstViewController];
    
    WSYQuickViewController *secondViewController = [[WSYQuickViewController alloc] init];
